...
namespace Msgframework\Lib\Registry\Tests;
...
class RegistryTest extends TestCase
{
    ...
    public function testAValueIsStoredToTheRegistry()
    {
        ...
        $this->assertSame('testsetvalue1', $a->get('foo'), 'The current value should be returned when assigning a key for the first time.');
        $a->set('foo', 'testsetvalue2');
        $this->assertSame('testsetvalue2', $a->get('foo'), 'The new value should be returned when assigning a key multiple times.');
    }
    ...
    public function testTheRegistryIsUnchangedWhenDeletingANonExistingValue()
    {
        ...
        $this->assertEquals(['foo' => 'bar'], $a->toArray());
    }
